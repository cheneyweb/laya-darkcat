...
const store = new Store({
    state: {
        ...
        storyArr: ['9.22 星期天\n\n今天我在路边捡到了一只可爱的小猫！\n她实在是太可爱了，我给他起名叫大黑。\n从今天开始，我每天都要为她写日记。\n\n一回到家，她就开始在我的屋里抓耗子！真乖…\n\n但是妈妈很讨厌猫，我要把她藏起来，\n不能让妈妈看到。',
            ...
            '1.25 星期六\n\n今天是农历新年，这一个多月来妈妈再也没有露过面。\n就跟人间蒸发了一样。\n\n在妈妈不在身边的这段日子里，大黑操办了我生活中的一切。\n为我洗衣，为我做饭。把我照顾得无微不至。\n\n今晚的年夜饭我也将与她一起度过。\n你看她拿起刀叉的样子，可不可爱？',
            '9.2 			星期日\n\n时空扭转。今天是中元节，还有20天，就是我与大黑相识一周年了。\n中元节的传统是焚纸锭、祀亡魂。\n\n大黑一大早的就准备好了纸衣纸人，兴致勃勃的要跟我一起去河边祭祖。\n可问题是，我都不知道该烧给谁呀。以前这些事都是妈妈做的。\n\n到了河边，大黑变戏法似的拿出悼文念了一通，居然跟妈妈当时念得一模一样。\n\n火烧的很大，点燃了大黑的裙摆样的大脸。\n好在旁边就是河水，火很快就灭了，只是她的样子反而更可爱了。',
            '10.1  星期四\n\n大今天是国庆，也是中秋，连续放八天假。\n不知道为什么，大黑今天很开心。\n我已经一年都没上学了，放不放假什么的，对我完全没有影响啊。\n\n今晚月圆，兴奋过度的大黑在阳台上对着月亮哼哼有声。\n“春天里那个百花香，啷类各啷类各啷类各啷”\n“火红的太阳当空照，照到了我的…”\n\n然后，她自那次烧伤后就带着的两个泡泡分裂成好几个。\n最后围着大头转成了一个圈。\n好可爱！',
            '2.3 星期三\n\n又一年春天到了，大黑发芽了。\n今天早上大黑没给我做早饭，我以为她生病了。\n急忙去药店给她买来感冒药。\n\n谁知回到家，推开她房门的时候，发现她在地上盘成一团。\n就这么发芽了。\n\n发芽的同时，还连带我的玩具飞船也被她的枝桠给粘上了。\n还能怎么办？\n重新再买玩具呗。',
            '3.5 星期五\n\n春天过去了一半，这几天窗外总是跑过去一些小黑猫。\n算算日子，大黑快三岁了，也该放眼未来了。\n\n只是小黑猫总是络绎不绝，只进不出。\n大黑也太厉害了吧？\n\n结果，今天大黑出来变成了“真黑”。\n这也太浮夸了吧，你是螳螂吗！？',
            '6.1 星期二\n\n今天我不想写日记。\n别问我为什么。\n\n因为我真的写不下去了。\n大黑居然变成了这个样子。\n\n怀孕仨月，她并没有生下小猫。\n反而生了个自己出来。\n然后下半身变成了我的样子，套了件斗篷。\n\n还变出根木棍把自己吊在上面。\n我不明白她什么意思，也不想知道。',
        ],
